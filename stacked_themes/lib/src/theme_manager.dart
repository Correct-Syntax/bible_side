...
You can supply either a list of ThemeData objects to the themes property or a lightTheme and a darkTheme to be swapped between.
    ...
    if (hasMultipleThemes) {
      ...
      if (_selectedThemeMode == ThemeMode.system) {
        final brightness = ambiguate(SchedulerBinding.instance)!.platformDispatcher.platformBrightness;
    ...
    ThemeModel _currTheme =
        ThemeModel(selectedTheme: selectedTheme, darkTheme: darkTheme, themeMode: _selectedThemeMode);
  ...
  void toggleDarkLightTheme([bool disablePersistence = false]) {
    ...
    updateOverlayColors(_selectedThemeMode == ThemeMode.dark ? darkTheme : lightTheme);
    _themesController.add(ThemeModel(
  ...
  void setThemeMode(ThemeMode themeMode) {
    ...
    if (themeMode != ThemeMode.system) {
      ...
      var currentBrightness = ambiguate(SchedulerBinding.instance)!.platformDispatcher.platformBrightness;
      updateOverlayColors(currentBrightness == Brightness.dark ? darkTheme : lightTheme);
    }
  ...
  void setThemes({ThemeData? lightTheme, ThemeData? darkTheme}) {
    ...
    if (_selectedThemeMode != ThemeMode.system) {
      ...
      var currentBrightness = ambiguate(SchedulerBinding.instance)!.window.platformBrightness;
      updateOverlayColors(currentBrightness == Brightness.dark ? darkTheme : lightTheme);
    }
